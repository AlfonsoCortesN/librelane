  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
    ...
    initial begin	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7]
        ...
        r_buffer_req_uop_br_mask = {_RANDOM[6'h4][31:29], _RANDOM[6'h5][4:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_rob_idx = _RANDOM[6'h6][24:20];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_pdst = _RANDOM[6'h7][6:1];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_is_amo = _RANDOM[6'hA][19];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_uses_ldq = _RANDOM[6'hA][20];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_uses_stq = _RANDOM[6'hA][21];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_dst_rtype = _RANDOM[6'hB][20:19];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_req_uop_fp_val = _RANDOM[6'hB][26];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :98:25]
        r_buffer_fin_typeTagIn = _RANDOM[6'h12][18:17];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_div = _RANDOM[6'h12][25];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_sqrt = _RANDOM[6'h12][26];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_rm = _RANDOM[6'h12][31:29];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_in1 = {_RANDOM[6'h13][31:6], _RANDOM[6'h14], _RANDOM[6'h15][6:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_buffer_fin_in2 = {_RANDOM[6'h15][31:7], _RANDOM[6'h16], _RANDOM[6'h17][7:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :99:25]
        r_divsqrt_val = _RANDOM[6'h19][9];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30]
        r_divsqrt_killed = _RANDOM[6'h19][10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30, :146:29]
        r_divsqrt_fin_typeTagIn = _RANDOM[6'h19][19:18];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30, :147:26]
        r_divsqrt_fin_rm = {_RANDOM[6'h19][31:30], _RANDOM[6'h1A][0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :145:30, :147:26]
        r_divsqrt_uop_br_mask = _RANDOM[6'h25][13:6];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_rob_idx = {_RANDOM[6'h26][31:29], _RANDOM[6'h27][1:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_pdst = _RANDOM[6'h27][15:10];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_is_amo = _RANDOM[6'h2A][28];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_uses_ldq = _RANDOM[6'h2A][29];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_uses_stq = _RANDOM[6'h2A][30];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_dst_rtype = _RANDOM[6'h2B][29:28];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_divsqrt_uop_fp_val = _RANDOM[6'h2C][3];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26]
        r_out_val = _RANDOM[6'h2C][14];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :148:26, :184:26]
        r_out_uop_br_mask = _RANDOM[6'h31][18:11];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_rob_idx = _RANDOM[6'h33][6:2];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_pdst = _RANDOM[6'h33][20:15];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_is_amo = _RANDOM[6'h37][1];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_uses_ldq = _RANDOM[6'h37][2];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_uses_stq = _RANDOM[6'h37][3];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_dst_rtype = _RANDOM[6'h38][2:1];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_uop_fp_val = _RANDOM[6'h38][8];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22]
        r_out_flags_double = _RANDOM[6'h38][23:19];	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22, :186:31]
        r_out_wdata_double = {_RANDOM[6'h38][31:24], _RANDOM[6'h39], _RANDOM[6'h3A][24:0]};	// @[generators/boom/src/main/scala/v3/exu/execution-units/fdiv.scala:84:7, :185:22, :187:31]
      `endif // RANDOMIZE_REG_INIT
    end // initial
