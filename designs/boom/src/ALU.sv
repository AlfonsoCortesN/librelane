...
module ALU(	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:67:7]
  ...
  input  [63:0] io_in1,	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:56:14]
  ...
  wire [63:0] _io_adder_out_T_3 = io_in1 + in2_inv + {63'h0, io_fn[3]};	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:43:29, :69:20, :71:{26,36}]
  ...
  wire [37:0] _GEN_7 = {_shout_r_T_5[11:8], _shout_r_T_5[15:12], _shout_r_T_5[19:16], _shout_r_T_5[23:20], _shout_r_T_5[27:24], _shout_r_T_5[31:28], _shout_r_T_5[35:32], _shout_r_T_5[39:36], _shout_r_T_5[43:40], _shout_r_T_5[47:46]} & 38'h3333333333;	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:90:{70,79}, :91:24]
  wire [7:0]  _GEN_8 = _GEN_7[37:30] | {_shout_r_T_5[15:12], _shout_r_T_5[19:16]} & 8'h33;	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:90:70, :91:24]
  wire [1:0]  _GEN_9 = _GEN_7[27:26] | _shout_r_T_5[21:20];	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:90:70, :91:24]
  wire [7:0]  _GEN_10 = _GEN_7[21:14] | {_shout_r_T_5[31:28], _shout_r_T_5[35:32]} & 8'h33;	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:90:{70,79}, :91:24]
  wire [1:0]  _GEN_11 = _GEN_7[11:10] | _shout_r_T_5[37:36];	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:90:70, :91:24]
  wire [7:0]  _GEN_12 = {_GEN_7[5:0], 2'h0} | {_shout_r_T_5[47:44], _shout_r_T_5[51:48]} & 8'h33;	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:90:70, :91:24]
  wire [50:0] _GEN_13 = {_shout_r_T_5[5:4], _shout_r_T_5[7:6], _shout_r_T_5[9:8], _GEN_8, _shout_r_T_5[19:18], _GEN_9, _shout_r_T_5[23:22], _shout_r_T_5[25:24], _GEN_10, _shout_r_T_5[35:34], _GEN_11, _shout_r_T_5[39:38], _shout_r_T_5[41:40], _GEN_12, _shout_r_T_5[51:50], _shout_r_T_5[53:52], _shout_r_T_5[55]} & 51'h5555555555555;	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:90:70, :91:24]
  wire        _logic_T_4 = io_fn == 4'h6;	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:102:51]
  wire [63:0] out = io_fn == 4'h0 | io_fn == 4'hA ? _io_adder_out_T_3 : {63'h0, io_fn > 4'hB & (io_in1[63] == io_in2[63] ? _io_adder_out_T_3[63] : io_fn[1] ? io_in2[63] : io_in1[63])} | (io_fn == 4'h4 | _logic_T_4 ? io_in1 ^ in2_inv : 64'h0) | (_logic_T_4 | io_fn == 4'h7 ? io_in1 & io_in2 : 64'h0) | (_shout_T | _shout_T_1 ? _shout_r_T_5[63:0] : 64'h0) | (io_fn == 4'h1 ? {_shout_r_T_5[0], _shout_r_T_5[1], _shout_r_T_5[2], _shout_r_T_5[3], _shout_r_T_5[4], _GEN_13[50:47] | {_shout_r_T_5[7:6], _shout_r_T_5[9:8]} & 4'h5, _GEN_13[46:39] | _GEN_8 & 8'h55, _GEN_8[1], _GEN_13[37] | _shout_r_T_5[18], {_shout_r_T_5[19], 1'h0} | _GEN_9 & 2'h1, _GEN_13[34:31] | {_shout_r_T_5[23:22], _shout_r_T_5[25:24]} & 4'h5, _GEN_13[30:23] | _GEN_10 & 8'h55, _GEN_10[1], _GEN_13[21] | _shout_r_T_5[34], {_shout_r_T_5[35], 1'h0} | _GEN_11 & 2'h1, _GEN_13[18:15] | {_shout_r_T_5[39:38], _shout_r_T_5[41:40]} & 4'h5, _GEN_13[14:7] | _GEN_12 & 8'h55, _GEN_12[1], _GEN_13[5] | _shout_r_T_5[50], _shout_r_T_5[51], _shout_r_T_5[52], {_GEN_13[2:0], 1'h0} | {_shout_r_T_5[55:54], _shout_r_T_5[57:56]} & 4'h5, _shout_r_T_5[57], _shout_r_T_5[58], _shout_r_T_5[59], _shout_r_T_5[60], _shout_r_T_5[61], _shout_r_T_5[62], _shout_r_T_5[63]} : 64'h0);	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:44:30, :45:35, :69:20, :70:28, :71:{26,36}, :75:{8,15,24,34,56}, :76:8, :89:{24,50}, :90:{70,79}, :91:24, :92:{18,41,82}, :93:{18,25}, :102:{18,25,42,51,86}, :103:{18,41,50,75}, :105:{42,50,58}, :110:{16,23,40,49}]
  assign io_out = io_dw ? out : {{32{out[31]}}, out[31:0]};	// @[generators/rocket-chip/src/main/scala/rocket/ALU.scala:67:7, :110:16, :112:10, :115:{28,37,43,48,56,66}]
endmodule
