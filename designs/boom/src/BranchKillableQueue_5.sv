  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
    ...
    initial begin	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7]
        ...
        uops_0_br_mask = {_RANDOM[6'h4][31], _RANDOM[6'h5][6:0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_rob_idx = _RANDOM[6'h6][26:22];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_stq_idx = {_RANDOM[6'h6][31:30], _RANDOM[6'h7][0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_pdst = _RANDOM[6'h7][8:3];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_is_amo = _RANDOM[6'hA][21];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_uses_stq = _RANDOM[6'hA][23];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_dst_rtype = _RANDOM[6'hB][22:21];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_0_fp_val = _RANDOM[6'hB][28];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_uopc = _RANDOM[6'hC][13:7];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_br_mask = _RANDOM[6'h11][10:3];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_rob_idx = _RANDOM[6'h12][30:26];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_stq_idx = _RANDOM[6'h13][4:2];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_pdst = _RANDOM[6'h13][12:7];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_is_amo = _RANDOM[6'h16][25];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_uses_stq = _RANDOM[6'h16][27];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_dst_rtype = _RANDOM[6'h17][26:25];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_1_fp_val = _RANDOM[6'h18][0];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_uopc = _RANDOM[6'h18][17:11];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_br_mask = _RANDOM[6'h1D][14:7];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_rob_idx = {_RANDOM[6'h1E][31:30], _RANDOM[6'h1F][2:0]};	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_stq_idx = _RANDOM[6'h1F][8:6];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_pdst = _RANDOM[6'h1F][16:11];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_is_amo = _RANDOM[6'h22][29];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_uses_stq = _RANDOM[6'h22][31];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_dst_rtype = _RANDOM[6'h23][30:29];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        uops_2_fp_val = _RANDOM[6'h24][4];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20]
        enq_ptr_value = _RANDOM[6'h24][16:15];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM[6'h24][18:17];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[6'h24][19];	// @[generators/boom/src/main/scala/v3/util/util.scala:448:7, :466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
