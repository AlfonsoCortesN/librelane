...
module Frontend(	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
  ...
  wire [31:0] io_cpu_npc = {io_cpu_req_valid ? io_cpu_req_bits_pc[31:2] : s2_replay ? s2_pc[31:2] : predicted_npc[31:2], 2'h0};	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14, :117:22, :129:25, :134:46, :135:16, :186:28, :384:33]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
    ...
    s1_speculative <= io_cpu_req_valid ? io_cpu_req_bits_speculative : ~s2_replay | s2_speculative;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:116:27, :123:31, :134:46, :143:{24,75}]
    if (~s2_replay) begin	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:134:46, :143:75]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
        ...
        s2_tlb_resp_pf_inst = _RANDOM[3'h5][23];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_tlb_resp_ae_inst = _RANDOM[3'h5][29];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_tlb_resp_cacheable = _RANDOM[3'h6][1];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_speculative = _RANDOM[3'h6][11];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24, :123:31]
        s2_replay_REG = _RANDOM[3'h7][14];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :134:56]
        fq_io_enq_valid_REG = _RANDOM[3'h7][17];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :134:56, :184:29]
      `endif // RANDOMIZE_REG_INIT
    end // initial
