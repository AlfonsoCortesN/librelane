...
define_pdn_grid -macro -name {sram_grid} -voltage_domains {CORE} -cells {RM_IHPSG13_1P_1024x16_c2_bm_bist}
#define_pdn_grid -macro -name {sram_grid} -voltage_domains {CORE} -instances {memory.sram_0}  
add_pdn_stripe -grid {sram_grid} -layer {Metal5} -width {3} -pitch {20} -offset {1.0} -starts_with POWER
