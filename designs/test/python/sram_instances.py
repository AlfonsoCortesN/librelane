...
mem_path = "/home/alfonso/librelane/designs/test/no_compressed/chipyard.harness.TestHarness.MyRocketConfig.top.mems.v"
...
hierarchy_path = "/home/alfonso/librelane/designs/test/no_compressed/top_module_hierarchy.json"

with open(hierarchy_path, 'r') as file:
    data = json.load(file)

# top = data['instances'][0]['instances'][0]
sram_dict = find_sram("", data, {})
