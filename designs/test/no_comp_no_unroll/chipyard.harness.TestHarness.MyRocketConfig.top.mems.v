...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [31:0] RW0_rdata_0 = {RW0_rdata_0_1,RW0_rdata_0_0};
  wire [15:0] RW0_rdata_1_0 = mem_1_0_A_DOUT;
  wire [15:0] RW0_rdata_1_1 = mem_1_1_A_DOUT;
  wire [31:0] RW0_rdata_1 = {RW0_rdata_1_1,RW0_rdata_1_0};
  ...
  wire [9:0] _GEN_59 = {RW0_wmask[3],RW0_wmask[3],RW0_wmask[2],RW0_wmask[2],RW0_wmask[2],RW0_wmask[2],RW0_wmask[2],
    RW0_wmask[2],RW0_wmask[2],RW0_wmask[2]};
  wire [14:0] _GEN_69 = {RW0_wmask[3],RW0_wmask[3],RW0_wmask[3],RW0_wmask[3],RW0_wmask[3],_GEN_59};
  ...
  assign RW0_rdata = ~RW0_addr_sel_reg ? RW0_rdata_0 : RW0_addr_sel_reg ? RW0_rdata_1 : 32'h0;
  ...
  assign mem_0_0_A_BM = {RW0_wmask[1],_GEN_34};
  ...
  assign mem_0_1_A_BM = {RW0_wmask[3],_GEN_69};
  ...
  assign mem_1_0_A_BM = {RW0_wmask[1],_GEN_34};
  ...
  assign mem_1_1_A_BM = {RW0_wmask[3],_GEN_69};
