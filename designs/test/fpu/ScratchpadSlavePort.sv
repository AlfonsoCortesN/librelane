...
module ScratchpadSlavePort(	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
  ...
  output [7:0]  io_dmem_s1_data_mask,	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:44:16]
  ...
  wire [3:0]      _io_dmem_req_bits_mask_full_desired_mask_T_1 = {(io_dmem_req_bits_req_addr[1] ? _io_dmem_req_bits_mask_full_desired_mask_T : 2'h0) | {2{io_dmem_req_bits_req_size[1]}}, io_dmem_req_bits_req_addr[1] ? 2'h0 : _io_dmem_req_bits_mask_full_desired_mask_T};	// @[generators/rocket-chip/src/main/scala/rocket/AMOALU.scala:20:{22,27,42,47,53}, :21:22, :22:16, generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:119:41]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
    if (reset)	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9]
      ...
      state <= 3'h3;	// @[generators/rocket-chip/src/main/scala/rocket/ScratchpadSlavePort.scala:43:9, :53:24]
